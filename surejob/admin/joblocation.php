                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Job Location <small>Manage Job Location</small>
                        </h1>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-header">
                            <h3 class="modal-title"> <font face="verdana">Add Job Location Here </font></h3>
    ...
    <tr>
      ...
      <td><?php echo $rows['job_location'];?></td>
       ...
       <td>
         ...
         <a href="joblocation.php?dlt_id=<?php echo $rows['id'];?>" class="btn btn-danger btn-sm" name="delete_btn">DELETE</a>
...
$query = "DELETE FROM tbl_job_location WHERE id='$id' ";
