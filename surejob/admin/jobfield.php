...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Job Field <small>Manage Job Field</small>
                        </h1>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-header">
                            <h3 class="modal-title"> <font face="verdana">Add Job Field Here </font></h3>
                            
                          </div>

                          <!-- Modal body -->
                          <div class="modal-body">
                            <form action="add_jobfield.php" method="POST">
                             
                              <div class="form-group">
                                <label for="text">Job Field Name:</label>
                                <input type="text" class="form-control" name="jobfieldname" placeholder="Job field Name">
                              </div>
  ...
  <thead>
    <tr>
      ...
      <th class="th-sm">Job-Field Name</th>
...
while($rows = $result->fetch_assoc())
{
 ?>
    ...
    <tr>
      ...
      <td><?php echo $rows['job_field'];?></td>
      
       <td>
          <a href="#" class="btn btn-primary btn-sm">EDIT</a>
          <a href="jobfield.php?dlt_id=<?php echo $rows['id'];?>" class="btn btn-danger btn-sm" name="delete_btn">DELETE</a>
...
$query = "DELETE FROM tbl_job_field WHERE id='$id' ";
