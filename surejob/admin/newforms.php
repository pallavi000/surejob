...
<body>
 ...
 <table id="example" class="table table-striped table-bordered " cellspacing="0" width="100%">
  ...
  $query="SELECT * FROM tbl_users WHERE status='pending'";
  ...
  ?>
    <tr>
      ...
      <td><a href="../upload/<?php echo $rows['files'];?>" target="_blank"><?php echo $rows['files'];?></a></td>
      <td><?php echo $rows['gender'];?></td>
       <td>
        
          <a href="newforms.php?approveid=<?php echo $rows['id'];?>" type="button" class="btn btn-primary btn-sm">Approve</a>
          <a href="newforms.php?denyid=<?php echo $rows['id'];?>" class="btn btn-danger btn-sm">Deny</a>
        </td>
...
if(isset($_GET['approveid'])){
  $id = $_GET['approveid'];
  include '../openconnection.php';
  $query = "UPDATE tbl_users set status='approved' where id='$id'";
  if($conn->query($query)){
  ?>
  <script type="text/javascript">
...
if(isset($_GET['denyid'])){
  $id = $_GET['denyid'];
  include '../openconnection.php';
  $query = "UPDATE tbl_users set status='denied' where id='$id'";
  if($conn->query($query)){
  ?>
  <script type="text/javascript">
