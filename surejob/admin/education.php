...
<body>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-label">
                           <li>
                            ...
                            <li>
                                <a href="newforms.php">Denied Forms</a>
                            </li>



                            <li>
                                <a href="newforms.php">All Forms</a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Education <small>Manage Education</small>
                        </h1>
                          ...
                          <div class="modal-body">
                            <form action="add_education.php" method="POST">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="educationname" placeholder="Education Name">
                              </div>
 ...
 <table id="example" class="table table-striped table-bordered " cellspacing="0" width="100%">
  <thead>
    <tr>
    <th class="th-sm ">Education Name</th>
...
while($rows = $result->fetch_assoc())
{
 ?>
    ...
    <tr>
      ...
      <td><?php echo $rows['education_name'];?></td>
      
       <td>
          <a href="#" class="btn btn-primary btn-sm">EDIT</a>
          <a href="education.php?dlt_id=<?php echo $rows['id'];?>" class="btn btn-danger btn-sm" name="delete_btn">DELETE</a>
        </td>
...
$query = "DELETE FROM tbl_education WHERE id='$id' ";
