        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="table.php"><i class="fa fa-table"></i>Forms</a>
                    </li>
                     <li>
                        <a href="notice.php"><i class="fa fa-pencil"></i>Manage Notice</a>
                    </li>
                     <li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Submitted Forms <small>The submitted web forms.</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
